      ...
      <div class="row">
        <div class="col-lg-7 col-md-12">
          <div class="wd-review-job thumb2 widget-counter stc">
            <div class="thumb">
              <img src="{{asset('app-assets/users/images/landing-pages/home13.jpg')}}" alt="images">
            </div>
            <div class="trader-box">
              ...
              <div class="shape ani7">
                <img src="{{asset('app-assets/users/images/review/shape.png')}}" alt="images">
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="group-counter wow fadeInUp">
              ...
              <img class="thumb ani4" src="{{asset('app-assets/users/images/partners/thum-1.png')}}" alt="images">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="group-col-3">
            <div class="tf-iconbox style-3 cl3 stc2">
              <div class="box-header">
                <div class="img1">
                  <img src="{{asset('app-assets/users/images/job/work-icon-1.jpg')}}" alt="">
                </div>
              </div>
            ...
            <div class="tf-iconbox style-3 cl3 stc2">
              <div class="box-header">
                <div class="img1">
                  <img src="{{asset('app-assets/users/images/job/work-icon-2.jpg')}}" alt="">
                </div>
              </div>
              <div class="box-content">
                <h6 class="box-title">
            ...
            <div class="tf-iconbox style-3 cl3 stc2">
              <div class="box-header">
                <div class="img1">
                  <img src="{{asset('app-assets/users/images/job/work-icon-3.jpg')}}" alt="">
                </div>
              </div>
              <div class="box-content ">
                <h6 class="box-title">
    ...
    <div class="row">
          <div class="col-lg-6 col-md-12">
            <div class="wd-review-job thumb1 widget-counter">
              <div class="thumb">
                <img src="{{asset('app-assets/users/images/landing-pages/mb1.jpg')}}" alt="images">
                  ...
                  <div class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="27" viewBox="0 0 26 27" fill="none">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        stroke="#0c3438" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                      <circle cx="13" cy="13.7949" r="12" stroke="#0c3438" stroke-width="2" stroke-linecap="round"
                ...
                <div class="group-tab menu-tab">
                  <div class="user-tag tag1">
                    <img src="{{asset('app-assets/users/images/review/user1.jpg')}}" alt="images">
                  </div>
                  <div class="user-tag tag2">
                    <img src="{{asset('app-assets/users/images/review/user2.jpg')}}" alt="images">
                  </div>
                  <div class="user-tag tag3">
                    <img src="{{asset('app-assets/users/images/review/user3.jpg')}}" alt="images">
                  </div>
                  <div class="user-tag tag4 active">
                    <img src="{{asset('app-assets/users/images/review/user4.jpg')}}" alt="images">
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="wd-testimonials">
                    ...
                    <div class="author-group">
                      <div class="avatar">
                        <img src="{{asset('app-assets/users/images/review/testimonials.jpg')}}" alt="images">
                      </div>
                      <div class="infor">
                        <h6>Pete Jones</h6>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <a class="logo-partner" href="#">
                <img src="{{asset('app-assets/users/images/partners/page-logo-1.png')}}" alt="images/partners/page-logo-1">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="logo-partner">
                <img src="{{asset('app-assets/users/images/partners/page-logo-2.png')}}" alt="images/partners/page-logo-2">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="logo-partner">
                <img src="{{asset('app-assets/users/images/partners/page-logo-3.png')}}" alt="images/partners/page-logo-3">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="logo-partner">
                <img src="{{asset('app-assets/users/images/partners/page-logo-4.png')}}" alt="images/partners/page-logo-4">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="logo-partner">
                <img src="{{asset('app-assets/users/images/partners/page-logo-5.png')}}" alt="images/partners/page-logo-5">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="logo-partner">
                <img src="{{asset('app-assets/users/images/partners/page-logo-6.png')}}" alt="images/partners/page-logo-6">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="logo-partner">
                <img src="{{asset('app-assets/users/images/partners/page-logo-7.png')}}" alt="images/partners/page-logo-7">
              </a>
            </div>
            <div class="swiper-slide">
              <a class="logo-partner" href="#">
