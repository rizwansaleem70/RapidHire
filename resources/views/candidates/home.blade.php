                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="group-category-job  wow fadeInUp row">
                            @if (count($home['departments']) > 0)
                                @foreach ($home['departments'] as $department)
                                    <div class="job-category-box">
                                        <a href="{{ route('candidate.job.list') }}?department_id={{ $department->id }}"
                                            style="color: #000000 !important;">
                                            <div class="job-category-header">
                                                <p class="d-block fs-5 fw-bold" style="height: 50px;">
                                                    {{ $department->name }}</p>
                                            </div>
                            ...
                            @else
                                <center>
                                    <div class="alert alert-info">No Department found.</div>
                                </center>
                            @endif
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="group-category-job  wow">
                            @if (count($home['jobs']) > 0)
                                @foreach ($home['jobs'] as $job)
                                    <div class="job-category-box2 ">
                                        ...
                                        <img
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAYAAABXAvmHAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAX0lEQVR4nO3SwQmAMBBE0dQSS8zBQxqwyLDDdiBkIUctQM8a5T/4BQxMSgAAAAAAAK/a3ZculTBbZ65LZbjny4AwayEdn8is/W/AcM8h1S5tMxdSvb0QAAAAAABAetIJeOBba7Ua6isAAAAASUVORK5CYII=">
                            ...
                            @else
                                <center>
                                    <div class="alert alert-info">No Trending Jobs found.</div>
                                </center>
                            @endif
                        </div>
                    </div>
                            ...
                            <div class="icon bg-white">
                                <svg width="42" height="43" viewBox="0 0 42 43" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path d="M10.8778 37.221L10.1426 40.9928" stroke="#148160" stroke-width="2"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M15.4209 37.9753H39.5511" stroke="#148160" stroke-width="2"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path
                                    ...
                                    <path d="M22.208 34.2035L25.9783 24.3969H40.3056L36.5353 34.2035H22.208Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path d="M28.9951 37.9753V34.2035" stroke="#148160" stroke-width="2"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </div>

                        </div>
                        <img class="connect-line"
                            src="{{ asset('app-assets/candidates/images/used/connect line.png') }}">
                        ...
                        <div class="box-header">
                            <div class="icon bg-white">
                                <svg width="53" height="53" viewBox="0 0 53 53" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M7.61922 24.7886C9.85644 24.7886 11.67 22.9833 11.67 20.7564C11.67 18.5294 9.85644 16.7241 7.61922 16.7241C5.382 16.7241 3.56836 18.5294 3.56836 20.7564C3.56836 22.9833 5.382 24.7886 7.61922 24.7886Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                        d="M12.5576 34.406C13.5048 34.0431 14.1094 33.156 14.1094 32.1479V31.2406C14.1094 26.4019 11.1469 24.789 8.28508 24.789H6.99523C4.13344 24.789 1.1709 26.4019 1.1709 31.2406V32.1479C1.1709 33.156 1.79565 34.0431 2.7227 34.406C3.83114 34.8293 5.52401 35.2729 7.64013 35.2729C9.75624 35.2729 11.429 34.8293 12.5576 34.406Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                        d="M26.2422 40.9178C28.4794 40.9178 30.2931 39.1125 30.2931 36.8855C30.2931 34.6586 28.4794 32.8533 26.2422 32.8533C24.005 32.8533 22.1914 34.6586 22.1914 36.8855C22.1914 39.1125 24.005 40.9178 26.2422 40.9178Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                        d="M31.1587 50.5342C32.1059 50.1713 32.7105 49.2842 32.7105 48.2761V47.3688C32.7105 42.5301 29.7479 40.9172 26.8861 40.9172H25.5963C22.7345 40.9172 19.772 42.5301 19.772 47.3688V48.2761C19.772 49.2842 20.3967 50.1713 21.3238 50.5342C22.4322 50.9576 24.1251 51.4011 26.2412 51.4011C28.3573 51.4011 30.0301 50.9576 31.1587 50.5342Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                        d="M26.2422 9.46637C28.4794 9.46637 30.2931 7.66107 30.2931 5.43411C30.2931 3.20716 28.4794 1.40186 26.2422 1.40186C24.005 1.40186 22.1914 3.20716 22.1914 5.43411C22.1914 7.66107 24.005 9.46637 26.2422 9.46637Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                        d="M31.1587 19.0828C32.1059 18.7199 32.7105 17.8328 32.7105 16.8247V15.9174C32.7105 11.0787 29.7479 9.46582 26.8861 9.46582H25.5963C22.7345 9.46582 19.772 11.0787 19.772 15.9174V16.8247C19.772 17.8328 20.3967 18.7199 21.3238 19.0828C22.4322 19.5061 24.1251 19.9497 26.2412 19.9497C28.3573 19.9497 30.0301 19.5061 31.1587 19.0828Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                        d="M44.7017 24.7886C46.939 24.7886 48.7526 22.9833 48.7526 20.7564C48.7526 18.5294 46.939 16.7241 44.7017 16.7241C42.4645 16.7241 40.6509 18.5294 40.6509 20.7564C40.6509 22.9833 42.4645 24.7886 44.7017 24.7886Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                                    <path
                                        d="M49.6401 34.406C50.5873 34.0431 51.1919 33.156 51.1919 32.1479V31.2406C51.1919 26.4019 48.2294 24.789 45.3676 24.789H44.0777C41.216 24.789 38.2534 26.4019 38.2534 31.2406V32.1479C38.2534 33.156 38.8782 34.0431 39.8052 34.406C40.9137 34.8293 42.6065 35.2729 44.7226 35.2729C46.8388 35.2729 48.5115 34.8293 49.6401 34.406Z"
                                        stroke="#148160" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
                                        stroke-linejoin="round"></path>
                ...
                <div class="wd-employer">
                    <div class="tf-title">
                        <div class="group-title text-center mt-5">
                            ...
                            <img src="{{ asset('app-assets/candidates/images/used/path2987.png') }}"
