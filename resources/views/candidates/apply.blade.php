                    ...
                    <article class="job-article tf-tab single-job">
                        ...
                        <div class="content-tab">
                            <div class="inner-content">
                                ...
                                <p class="mg-19">Deloitte's Green Dot Agency is looking to add a Lead User Experience
                                    Designer to our
                                    experience design team. We want a passionate creative who's inspired by new trends
                                    and emerging
                                    technologies, and is able to integrate them into memorable user experiences. A
                                    problem solver who is
                                    entrepreneurial, collaborative, hungry, and humble; can deliver beautifully
                                    designed, leading-edge
                                    experiences under tight deadlines; and who has demonstrated proven expertise.
                                </p>
                                <h6>The Work You'll Do:</h6>
                                <ul class="list-dot">
                                    <li> Support the Creative Directors and Associate Creative Directors of experience
                                        design to concept and
                                        oversee the production of bold, innovative, award-winning campaigns and digital
                                        experiences.
                                    </li>
                                    <li> Make strategic and tactical UX decisions related to design and usability as
                                        well as features and
                                        functions.
                                    </li>
                                    <li> Creates low- and high-fidelity wireframes that represent a user's journey.</li>
                                    <li> Effectively pitch wireframes to and solutions to stakeholders. You'll be the
                                        greatest advocate for
                                        our work, but you'll also listen and internalize feedback so that we can come
                                        back with creative that
                                        exceeds expectations.
                                    </li>
                                </ul>
                                <h6>What you'll bring:</h6>
                                <ul class="list-dot mg-bt-15">
                                    <li>Passion for Human-Centered Design-a drive to make interactive technology better
                                        for people.
                                    </li>
                                    <li>Thorough knowledge of UX/UI best practices.</li>
                                    <li>Understanding of brand identity and working within a defined design system as
                                        well as contributing
                                        to it.
                                    </li>
                                    <li>A mastery of craft. You dream about color, typography, and interaction design
                                        every day. You are
                                        proficient using tools like Figma and Adobe XD. You can efficiently use your
                                        skill set to develop new
                                        designs within existing and new visual systems and design languages.
                                    </li>
                                    <li>A portfolio which highlights strong understanding of UX design including but not
                                        limited to: user
                                        flows, IA, and translating customer research, analytics, and insights into
                                        wireframes and
                                        high-fidelity designs.
                                    </li>
                                    <li>Possess problem-solving skills, an investigative mentality, and a proactive
                                        nature-committed to
                                ...
                                <ul class="list-dot mg-bt-15">
                                    ...
                                    <li>2 years of experience with design thinking or similar framework that focuses on
                                        defining users'
                                        needs early.
                                    </li>
                                    <li>Strong portfolio showing expert concept, layout, and typographic skills, as well
                                        as creativity and
                                        ability to adhere to brand standards.
                                    </li>
                                    <li>Expertise in Figma, Adobe Creative Cloud suite, Microsoft suite.</li>
                                    <li>Ability to collaborate well with cross-disciplinary agency team and stakeholders
                                        at all levels.
                                    </li>
                                    <li>Forever learning: Relentless desire to learn and leverage the latest web
                                        technologies.
                                    </li>
                                    <li>Detail-oriented: You must be highly organized, be able to multi-task, and meet
                                        tight deadlines.
                                    </li>
                                    <li>Independence: The ability to make things happen with limited direction.
                                        Excellent proactive
                                        attitude, take-charge personality, and "can-do" demeanor.
                                    </li>
                                    <li>Proficiency with Front-End UI technologies a bonus but not necessary (such as
                                        HTML, CSS,
                                        JavaScript).
                                    </li>
                                </ul>
                                <p>For individuals assigned and/or hired to work in Colorado or Nevada, Deloitte is
                                    required by law to
                                    include a reasonable estimate of the compensation range for this role. This
                                    compensation range is
                                    specific to the State of Colorado and the State of Nevada and takes into account the
                                    wide range of
                                    factors that are considered in making compensation decisions including but not
                                    limited to skill sets;
                                    experience and training; licensure and certifications; and other business and
                                    organizational needs. The
                                    disclosed range estimate has not been adjusted for the applicable geographic
                                    differential associated
                                    with the location at which the position may be filled. At Deloitte, it is not
                                    typical for an individual
                                    to be hired at or near the top of the range for their role and compensation
                                    decisions are dependent on
                                    the facts and circumstances of each case. A reasonable estimate of the current range
                                    is $86425- $177470.
                                </p>
                                <p>You may also be eligible to participate in a discretionary annual incentive program,
                                    subject to the
                                    rules governing the program, whereby an award, if any, depends on various factors,
                                    including, without
                                ...
                                <div class="video-thumb">
                                    <div class="content-tab2">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="{{asset('app-assets/candidates/images/review/thumbv3.jpg')}}"
                                                     alt="images">
                                    ...
                                    <ul class="thumb-menu menu-tab2">
                                        <li class="ct-tab2"><a class="lightbox-gallery"
                                                               href="images/review/thumbv4.jpg"><img
                                                        src="{{asset('app-assets/candidates/images/review/thumbv4.jpg')}}"
                                                        alt="images"></a></li>
                                        <li class="ct-tab2"><a class="lightbox-gallery"
                                                               href="images/review/thumbv1.jpg"><img
                                                        src="{{asset('app-assets/candidates/images/review/thumbv1.jpg')}}"
                                                        alt="images"></a></li>
                                        <li class="ct-tab2"><a class="lightbox-gallery"
                                                               href="images/review/thumbv2.jpg"><img
                                                        src="{{asset('app-assets/candidates/images/review/thumbv2.jpg')}}"
                                                        alt="images"></a></li>
                                    </ul>
                                </div>
                                        ...
                                        <li class="client-item">
                                            <div class="content">
                                                <div class="top-content">
                                                    <div class="avatar">
                                                        <div class="avt">
                                                            <img src="{{asset('app-assets/candidates/images/review/avt.jpg')}}"
                                                                 alt="images">
                                                        </div>
                                                        <div class="infor">
                                                            <h5><a href="#">Dianne Russell</a>
                                                            ...
                                                            <p>Great 401K benefits- not based on a match but is 8%
                                                                contribution</p>
                                                        </div>
                                                    </div>

                                                </div>
                                                <a href="#" class="btn-like">Was this helpful?
                    ...
                    <div class="cv-form-details po-sticky job-sg">
                        ...
                        <ul class="list-infor">
                            <li>
                                ...
                                <div class="detail"><a href="#">avitex.vn</a></div>
                            </li>
                            <li>
                                <div class="category">Email</div>
                                <div class="detail">hi.avitex@gmail.com</div>
                            </li>
                            <li>
                                <div class="category">Industry</div>
                                <div class="detail">Internet Publishing</div>
                            </li>
                            <li>
                                <div class="category">Company size</div>
                                <div class="detail">51-200 employees</div>
                            </li>
                            <li>
                                <div class="category">Headquarters</div>
                                <div class="detail">3 S Valley , Las Vegas, USA</div>
                            </li>
                            <li>
                                <div class="category">Founded</div>
                                <div class="detail">2017</div>
                            </li>
                        </ul>
